    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature', models.TextField(blank=True, help_text="User's signature", null=True, verbose_name='signature')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_reset_tokens', related_query_name='passowrd_reset_token', to='authentication.user', verbose_name='user')),
            ],
            options={
