    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_reset_tokens', related_query_name='password_reset_token', to='authentication.user', verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, help_text='Specify how user is being authenticated (e.g. credentials, oauth).', max_length=50, null=True, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='type')),
                ...
                ('user', models.ForeignKey(blank=True, help_text='User this account is related to.', on_delete=django.db.models.deletion.CASCADE, related_name='accounts', related_query_name='account', to='authentication.user', verbose_name='user')),
            ],
            options={
