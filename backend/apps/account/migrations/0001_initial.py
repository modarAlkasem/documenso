    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(blank=True, help_text='Purpose or the target of token.', max_length=255, validators=[django.core.validators.MinLengthValidator(3)], verbose_name='identifier')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='verification_tokens', related_query_name='verification_token', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
