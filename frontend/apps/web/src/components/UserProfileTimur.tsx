...
import { File, VerifiedIcon } from "lucide-react";
...
const UserProfileTimur = ({ className, rows = 2 }: UserProfileTimurProps) => {
    ...
    >
      ...
      <div className="mt-6">
        <div className="flex items-center justify-center gap-x-2">
          <h2 className="text-2xl font-semibold"> Timur Ecran</h2>
          ...
          {Array(rows)
            ...
            .map((_, index) => {
              return (
                <div
                  key={index}
                  className="bg-background flex items-center justify-center gap-x-6 p-4"
                >
                  <div className="flex items-center gap-x-2">
                    <File
                      className="text-muted-foreground/80 h-8 w-8"
                      strokeWidth={1.5}
                    />
...
export default UserProfileTimur;
